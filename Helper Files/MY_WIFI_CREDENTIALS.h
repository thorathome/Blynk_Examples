...
#define MY_WIFI_PASSWORD  "this is so secret999@!"       // network password

#define MY_WIFI_SSID2     "MyPhonesHSpot"                // network SSID (name)
#define MY_WIFI_PASSWORD2 "also very secret86$"          // network password
// Use #2 as a backup SSID if #1 fails so I can use my phone to reconnect, reprogram when needed
